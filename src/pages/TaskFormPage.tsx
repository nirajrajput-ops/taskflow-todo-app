    ...
    if (isEdit && existingTask) {
      ...
      if (typeof pendo !== 'undefined') {
        pendo.track('task_updated', {
          ...
          priorityChanged: taskData.priority !== existingTask.priority,
          categoryChanged: taskData.categoryId !== existingTask.categoryId,
          dueDateChanged: taskData.dueDate !== existingTask.dueDate,
        });
      }
