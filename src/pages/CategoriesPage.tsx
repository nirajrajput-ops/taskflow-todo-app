...
export const CategoriesPage: React.FC = () => {
  ...
  const handleAddCategory = () => {
    ...
    if (errors.length > 0) {
      ...
      if (typeof window !== 'undefined' && (window as any).pendo) {
        (window as any).pendo.track('form_validation_error', {
          ...
          error_fields: errors[0].field,
          error_count: errors.length,
          is_edit_form: false,
          first_error_field: errors[0].field,
          first_error_message: errors[0].message,
        });
      }
    ...
    if (typeof window !== 'undefined' && (window as any).pendo) {
      (window as any).pendo.track('category_created', {
        category_id: '', // Will be generated by addCategory
        category_name: newCategoryName.trim(),
        category_color: newCategoryColor,
        name_length: newCategoryName.trim().length,
  ...
  const handleUpdateCategory = () => {
    ...
    const oldColor = editingCategory.color;
    const taskCount = getCategoryTaskCount(editingCategory.id);
    ...
    if (typeof window !== 'undefined' && (window as any).pendo) {
      (window as any).pendo.track('category_updated', {
        ...
        name_changed: oldName !== newCategoryName.trim(),
        color_changed: oldColor !== newCategoryColor,
  ...
  const handleDeleteCategory = () => {
    ...
    if (typeof window !== 'undefined' && (window as any).pendo) {
      (window as any).pendo.track('category_deleted', {
        ...
        reassign_to_category_name: reassignCategory?.name || 'Unknown',
